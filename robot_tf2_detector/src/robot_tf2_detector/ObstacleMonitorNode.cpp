...
ObstacleMonitorNode::ObstacleMonitorNode(): Node("obstacle_monitor"), tf_buffer_(), tf_listener_(tf_buffer_)
{
  //marker_pub_ = create_publisher<visualization_msgs::msg::Marker>("obstacle_marker", _1);
